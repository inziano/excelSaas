    ...
    <div>
        <nav class="flex bg-white flex-wrap items-center justify-between p-4">
            ...
            <div class="navbar-menu hidden lg:order-1 lg:block w-full lg:w-2/5">
                <router-link to="/"  class="block lg:inline-block mt-4 lg:mt-0 mr-10 text-blue-900 hover:text-indigo-600" >
                    Home
                </router-link>

                 <router-link to="/upload"  class="block lg:inline-block mt-4 lg:mt-0 mr-10 text-blue-900 hover:text-indigo-600" >
                    Upload
                </router-link>

                 <router-link to="/uploads"  class="block lg:inline-block mt-4 lg:mt-0 mr-10 text-blue-900 hover:text-indigo-600" >
                    All Uploads
                </router-link>
                
            </div>
            <div class="navbar-menu hidden lg:order-3 lg:block w-full lg:w-2/5 lg:text-right">
                 <router-link to="/login"  class="block lg:inline-block mt-4 lg:mt-0 mr-10 text-blue-900 hover:text-indigo-600" >
                    Login
                </router-link>
                 <router-link to="/register"  class="block lg:inline-block mt-4 lg:mt-0 mr-10 text-blue-900 hover:text-indigo-600" >
                    Register
                </router-link>
            </div>
        </nav>

        <div class="w-full" style="min-height: 80vh">
            <router-view></router-view>
        </div>
        
        <footer class="bottom-0 px-3 py-8 bg-white dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
